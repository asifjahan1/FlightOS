...
class _SyntheticVisionPageState extends State<SyntheticVisionPage> {
  ...
  double _pitchOffset = 0.0; // Degrees
  double _rollOffset = 0.0; // Degrees
              ...
              child: Center(
                child: BlocBuilder<TelemetryBloc, TelemetryState>(
                  builder: (context, state) {
                    double telemetryPitch = 0;
                    double telemetryRoll = 0;
...
class RealisticAircraftPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    shadowPath.addPath(wingPath, Offset(0, 10));
    ...
    shadowPath.addPath(hStabPath, Offset(0, 8));
    ...
    shadowPath.addPath(vStabPath, Offset(0, 5));
...
class PitchLadderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawPitchLine(int degrees) {
      ...
      double lineWidth = isPositive ? 120.0 : 80.0;
      if (degrees % 10 != 0)
