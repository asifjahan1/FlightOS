      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const Divider(),
            if (_runways == null) const CircularProgressIndicator()
            else if (_runways!.isEmpty) const Text('No runway data.')
            ...
            const Divider(),
            if (_facilities == null) const CircularProgressIndicator()
            else if (_facilities!.isEmpty) const Text('No facilities found nearby.')
            else Wrap(
              spacing: 8.0,
              runSpacing: 4.0,
            ...
            const SizedBox(height: 24),
            // Weather
            Text('Weather Intelligence', style: Theme.of(context).textTheme.titleLarge),
            const Divider(),
